package cn.edu.hziee.springbootinterface.jsoup;
    ...
    public String getImage(String url) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                // 声明输出的文件
                OutputStream outstream = new FileOutputStream(new File("G:/picture/" + imageName));
                // 使用响应体输出文件
...
/*   private static CloseableHttpClient getClients(){
    ...
    public static void main(String[] args) throws IOException ,RuntimeException {
       String html=new HttpUtils().getHtml("https://t.bilibili.com/");
